function varnum = result_HL(input,watermark,name,band_name)
    ...
    %embedding watermark
    embedded_HL = host_HL + ( ((d*0.55)/k) * watermark_HL);
    embedded = idwt2(host_LL,host_LH,embedded_HL,host_HH,'haar');
    ...
    original_watermark_HL = (embedded_HL - host_HL)*(k/(d*0.55));
    extracted = idwt2(watermark_LL,watermark_LH,original_watermark_HL,watermark_HH,'haar');
